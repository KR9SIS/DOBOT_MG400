...
def connect_robot():
    try:
        ...
        move_p = 30003
        feed_p = 30004
        print("正在建立连接..., Establishing Connection")
...
if __name__ == "__main__":
    ...
    # ************************************
    # ************************************
    #     if instuction has PARAMS  条件编译 指令是否有参数
    #         0  指令不含参数, No PARAMS
    #         1   指令含参数, PARAMS
    #
    #     包括以下指令的例子, Examples include the following instructions：
    #         EnableRobot
    #         DisableRobot
    #         DO
    #         AccJ
    ...
    if PARAMS:
        ...
        value32 = 1
        dashboard.DOGroup(
            index, value, index2, value2, index32, value32
        )  # 64个参数  (参数省略)
    ...
    if PARAMS:
        ...
        move.MovL(
            x, y, z, r, userparam, toolparam, speedlparam, acclparam
        )  # 设置user  user  tool  speedl accl
        move.MovL(
            x, y, z, r, userparam, toolparam, speedlparam, acclparam, cpparam
        )  # 设置 user  tool  speedl accl cp
